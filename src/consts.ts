export const SITE_TITLE = "rizkraf";
export const SITE_DESCRIPTION =
  `Showcasing my projects, thoughts, and experiences as a software programmer`.trim();

export const KNOWN_TECH =
  `Vue.js,Nuxt,React,Next.js,Javascript,Typescript,SCSS,CSS,HTML,Astro,Tailwind CSS,Prisma,Drizzle,Git`.split(
    ",",
  );
